...
<section style="padding: 2.5em; background-color: #1c1c1c; border-radius: 12px; margin-bottom: 4em;"> <!--  for lighter background :  #1e1e1e -->
  ...
  <div style="display: flex; justify-content: center; gap: 2.5em; margin: 1.5em 0;">
    <img src="/assets/images/circular phylogeny Morpho.png" alt=" " style="width: 30%; border-radius: 10px;">
    <img src="/assets/images/CFD Morpho.png" alt=" " style="max-width: 500px; width: 100%; border-radius: 10px;">
  </div>
